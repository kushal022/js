...
7. The team with the lower odd is more likely to win. Print to the console which team is more likely to 
...
// Task: 7: not use if/else statement or ternary operator
